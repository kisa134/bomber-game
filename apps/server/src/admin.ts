...
<style>
  ...
  *{box-sizing:border-box;font-family:var(--font-ui)}
  ...
  .tile .value{font-family:var(--font-mono);font-size:1.7rem;font-weight:700;margin-top:6px;letter-spacing:-.01em}
  .tile.goal{border-color:rgba(52,211,153,.5);background:linear-gradient(180deg,rgba(52,211,153,.12),rgba(52,211,153,.05))}
