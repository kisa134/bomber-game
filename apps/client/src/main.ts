...
function syncSettingsUI(): void {
  ...
  for (const t of ["classic", "vault", "cyber", "void", "desert", "industrial", "chappie", "meme", "degen"]) {
...
function wireSettings(): void {
  ...
  for (const t of ["classic", "vault", "cyber", "void", "desert", "industrial", "chappie", "meme", "degen"] as const) {
