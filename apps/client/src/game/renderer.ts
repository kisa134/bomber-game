...
// Per-arena identity now lives in ONE place — arenaConfig.ts (ARENA_CONFIG). These are
// derived views so the reads below stay unchanged; a NEW map = one ARENA_CONFIG entry.
import { ARENA_THEMES, ATMOSPHERE, ARENA_GLOW, ARENA_LIGHT, ARENA_SCENE, FLOOR_PHYSICS } from "./arenaConfig.js";
