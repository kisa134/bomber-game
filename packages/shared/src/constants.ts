...
export const SKIN_PRICES = [0, 0, 0, 0, 0, 2500, 4000, 6000, 8000, 11000, 16000, 18000, 20000, 22000, 24000, 27000, 30000, 34000, 38000, 40000, 42000, 45000, 48000, 51000, 54000, 58000, 62000, 65000, 68000, 72000, 76000, 80000, 85000, 90000, 96000, 100000, 105000, 110000, 115000, 120000, 126000, 132000, 140000, 148000, 156000, 165000, 174000, 184000, 195000, 207000, 220000, 232000, 244000, 257000, 270000, 284000, 300000, 316000, 333000, 350000, 368000, 387000, 407000, 428000, 450000, 473000, 497000, 522000, 548000, 575000, 603000, 633000, 664000, 697000, 732000, 768000, 806000, 846000, 888000, 932000, 978000, 1027000, 1078000, 1132000, 1189000, 1248000, 1310000, 1376000, 1445000, 1517000, 1593000] as const;
// Player level required before a skin can be bought with chips. 0 = no gate.
export const SKIN_UNLOCK_LEVEL = [0, 0, 0, 0, 0, 4, 7, 10, 14, 18, 22, 24, 26, 28, 30, 33, 36, 39, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 72, 74, 76, 78, 80, 82, 84, 86, 88, 90, 92, 93, 94, 95, 96, 97, 98, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99] as const;
// Whole-token price to buy a skin INSTANTLY (bypasses the level gate). 0 = free.
export const SKIN_TOKEN_PRICES = [0, 0, 0, 0, 0, 10000, 20000, 35000, 50000, 80000, 150000, 170000, 185000, 200000, 220000, 245000, 270000, 300000, 330000, 350000, 370000, 390000, 410000, 440000, 470000, 500000, 540000, 580000, 620000, 660000, 700000, 750000, 800000, 860000, 920000, 980000, 1040000, 1100000, 1160000, 1220000, 1290000, 1360000, 1440000, 1520000, 1610000, 1700000, 1800000, 1900000, 2010000, 2130000, 2260000, 2400000, 2540000, 2690000, 2850000, 3010000, 3190000, 3370000, 3570000, 3760000, 3960000, 4170000, 4390000, 4620000, 4860000, 5110000, 5380000, 5650000, 5940000, 6240000, 6550000, 6880000, 7220000, 7580000, 7960000, 8360000, 8780000, 9220000, 9680000, 10160000, 10670000, 11200000, 11760000, 12350000, 12970000, 13620000, 14300000, 15020000, 15770000, 16560000, 17390000] as const;
